...
# ///
"""
at: Uninstall UX nudge hooks (best-effort, idempotent)
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Remove at-managed UX nudge hooks from project or user settings (idempotent).")
