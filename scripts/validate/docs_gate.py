...
warnings.warn(
    "docs_gate.py is deprecated and will be removed in v0.5.0. "
    "Docs validation will be merged into docs-keeper workflow. See scripts/DEPRECATED.md for migration.",
    DeprecationWarning,
    stacklevel=2
)
