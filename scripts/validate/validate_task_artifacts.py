...
warnings.warn(
    "validate_task_artifacts.py is deprecated and will be removed in v0.5.0. "
    "Agent validates own outputs per contract. See scripts/DEPRECATED.md for migration.",
    DeprecationWarning,
    stacklevel=2
)
